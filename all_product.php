         										...
         										<div class="content_wrapper"><!--content wrapper starts here!-->
                                                                   ...
                                                                   <div id="content_area">
                                                                    <?php cart();?>
																	 ...
																	 ?>
                                                                        ...
                                                                        <div  id="All" style="width:1000px; color:black; ">
																...
																while($row_pro=mysqli_fetch_array($run_pro)){
																	...
																	echo "
																			...
																			<div  class='well well-lg text wow fadeinleft' style='height:250px; width: 200px; float: left;margin-left:50px;margin-top:10px;margin-right:10px;background-color:transparent;'>
																...
																<p style='font-size:12px;'>$pro_title</p>
																<p style='font-size:12px;'><b><center>$pro_price rs </center></b></p>	
