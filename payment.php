...
<form method="post" action="payment.php" enctype="multipart/form-data">
    ...
    <div class="input-group">
  	  <input type="text" placeholder="Card number" name="card_no" required>
  	</div>
  	<div class="input-group">
  	  <input type="text" placeholder="Expires(MM/YY)" name="expires" required>
  	</div>
    <div class="input-group">
  	  <input type="text" placeholder="CSC(3 digit)" name="csc" required>
  	</div>
